...
namespace Ecoporto.Posicionamento
{
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/agendamentoConteiner")
                .Include("~/Content/js/agendamento/default.js",
                         "~/Content/js/agendamento/conteiner/agendamento.js"));

            bundles.Add(new ScriptBundle("~/bundles/agendamentoCargaSolta")
                .Include("~/Content/js/agendamento/default.js",
                         "~/Content/js/agendamento/cargasolta/agendamento.js"));

            bundles.Add(new ScriptBundle("~/bundles/agendamentoVeiculos")
                .Include("~/Content/js/agendamento/default.js",
                         "~/Content/js/agendamento/veiculos/agendamento.js"));
