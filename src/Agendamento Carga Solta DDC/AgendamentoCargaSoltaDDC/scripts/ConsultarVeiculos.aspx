<%@ Page Title="" Language="vb" enableEventValidation="false" AutoEventWireup="false" MasterPageFile="~/master/Site.Master"
    CodeBehind="ConsultarVeiculos.aspx.vb" Inherits="GPD.ConsultarVeiculos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="Grid-Scroll" style="overflow: auto; margin-left: 20px; margin-right: 20px;">
            ...
            <table id="tbcad" align="center" bgcolor="#999999" border="0" cellpadding="1" cellspacing="0"
                ...
                <tr>
                    ...
                    <td width="150px" align="left" bgcolor="White" style="border-bottom-style: dotted;
                        ...
                        <asp:TextBox ID="txtPlacaCavalo" runat="server" Font-Names="Verdana" 
                            Font-Size="11px" MaxLength="8" Width="200px"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td align="left" bgcolor="White" style="border-bottom-style: dotted; border-bottom-width: 1px;
                        ...
                        <asp:TextBox ID="txtPlacaCarreta" runat="server" Font-Names="Verdana"
                            Font-Size="11px" Width="200px" MaxLength="8"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td align="left" bgcolor="White" style="border-right-style: dotted; border-right-width: 1px;
                        border-right-color: #999999; border-bottom-style: dotted; border-bottom-width: 1px;
                        border-bottom-color: #999999;" width="100px">
                        <asp:DropDownList ID="cbFiltro5" runat="server" Font-Names="Verdana" Font-Size="11px">
                            <asp:ListItem Value="0">Exatamente Igual</asp:ListItem>
                            <asp:ListItem Value="1">Contém</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                ...
                <tr>
                    ...
                    <td align="left" bgcolor="White" style="border-right-style: dotted; border-right-width: 1px;
                        border-right-color: #999999; border-bottom-style: dotted; border-bottom-width: 1px;
                        border-bottom-color: #999999;" width="100px">
                        <asp:DropDownList ID="cbFiltro6" runat="server" Font-Names="Verdana" Font-Size="11px">
                            <asp:ListItem Value="0">Exatamente Igual</asp:ListItem>
                            <asp:ListItem Value="1">Contém</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                ...
                <tr>
                    ...
                    <td align="left" bgcolor="White" style="border-right-style: dotted; border-right-width: 1px;
                        border-right-color: #999999; border-bottom-style: dotted; border-bottom-width: 1px;
                        border-bottom-color: #999999;" width="100px">
                        <asp:DropDownList ID="cbFiltro7" runat="server" Enabled="False" Font-Names="Verdana"
                            Font-Size="11px">
                            <asp:ListItem Value="0">Exatamente Igual</asp:ListItem>
                            <asp:ListItem Value="1">Contém</asp:ListItem>
                        </asp:DropDownList>
                    ...
                    <td align="left" bgcolor="White" style="border-bottom-style: dotted; border-bottom-width: 1px;
                        ...
                        <asp:DropDownList ID="cbTipo" runat="server" Font-Names="Verdana" Font-Size="11px"
                            Width="100%">
                        </asp:DropDownList>
                    </td>
                </tr>
        ...
        <asp:GridView ID="DgVeiculos" runat="server" AutoGenerateColumns="False" CellPadding="1"
            ...
            AllowPaging="True" DataSourceID="DsConsulta" PageSize="15">
