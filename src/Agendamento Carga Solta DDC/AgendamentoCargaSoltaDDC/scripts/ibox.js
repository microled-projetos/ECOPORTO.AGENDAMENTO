...
var iBox = function() {
	var _pub = {
		...
		html: function(content, params) {
			...
			if (params.height) var height = params.height;
				...
				var height = els.content.offsetHeight + 0;
	...
	var create = function(elem) {
		...
		els.loading.innerHTML = 'Carregando...';
		els.loading.style.display = 'none';
	...
	var drawCSS = function() {
		...
		var core_styles = "#ibox_wrapper {background-color:#F8F8FF;}#ibox_footer_wrapper a {text-decoration:none;color:#333;font-weight:bold;font-family:Verdana, Arial, Helvetica, sans-serif;font-size:10px;}#ibox_loading {padding:50px;;color:#fff;font-size:16px;font-weight:bold;}#ibox {z-index:1000000;text-align:left;} #ibox_overlay {z-index:1000000;} #ibox_loading {position:absolute;z-index:1000001;} #ibox_wrapper {margin:30px;position:absolute;top:0;left:0;z-index:1000001;} #ibox_content {z-index:1000002;margin:20px 0px 0px 0px;padding:0px;} #ibox_content object {display:block;} #ibox_content .ibox_image {width:100%;height:100%;margin:0;padding:0;border:0;display:block;} #ibox_footer_wrapper a {float:right;display:block;outline:0;margin:0;padding:0;} #ibox_footer_wrapper {text-align:left;position:absolute;top:5px;right:5px;left:5px;white-space:nowrap;overflow:hidden;}";
