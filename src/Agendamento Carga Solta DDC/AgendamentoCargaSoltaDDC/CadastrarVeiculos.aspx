<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/master/Consultas.Master" CodeBehind="CadastrarVeiculos.aspx.vb" Inherits="AgendamentoCargaSoltaDDC.CadastrarVeiculos" %>
...
&nbsp;</td>
        ...
        <tr>
            <td style="font-family: verdana; font-size: 11px" width="100px" bgcolor="White">
                Renavam</td>
            <td style="font-family: verdana; font-size: 11px" bgcolor="White">
                <asp:TextBox ID="txtRenavam" runat="server" MaxLength="9" Width="200px" 
                    Font-Names="Verdana" Font-Size="11px" CssClass="Numeric"></asp:TextBox>
