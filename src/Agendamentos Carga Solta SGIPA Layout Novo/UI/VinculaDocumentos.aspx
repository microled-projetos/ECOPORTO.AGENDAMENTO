<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="VinculaDocumentos.aspx.vb" Inherits="AgendamentoCargaSoltaSGIPA.VinculaDocumentos" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <table style="width: 100%; border: 1px solid silver; border-collapse: collapse; font-family: Tahoma; font-size: 12px;">
                        ...
                        <tr>
                            <td>
                                ...
                                <table style="width: 100%;">
                                    <tr>
                                        <td colspan="3">São permitidos PDF - GIF - JPEG - PNG com tamanho máximo de 5MB<br />
                                            <br />
                                    ...
                                    <tr>
                                        <td width="150px">
                                            <asp:DropDownList ID="cbDocumentos" runat="server" Width="150px"  Enabled="false">
                                            </asp:DropDownList>
                                        </td>
                                        <td>
                                            <asp:FileUpload ID="txtUpload" runat="server" accept=".png, .jpg, .jpeg, .gif, .pdf" Width="260px" Enabled="false" />
                                        </td>
                                        <td align="right">
                                            <asp:Button ID="btnAnexar" runat="server" Text="Enviar Arquivo" OnClick="btnAnexar_Click" OnClientClick="MostrarProgresso();" Width="100px" Enabled="False" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="3">
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="gdvDocumentos" runat="server" CellPadding="4" ForeColor="#333333"
                                    GridLines="None" Width="100%" AutoGenerateColumns="False"
                                    EmptyDataText="Nenhum documento anexado" ShowHeaderWhenEmpty="True" DataKeyNames="AUTONUM_AV_IMAGEM">
