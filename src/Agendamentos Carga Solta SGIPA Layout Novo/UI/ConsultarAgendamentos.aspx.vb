...
Public Class ConsultarAgendamentos
    ...
    Protected Sub btNovo_Click(ByVal sender As Object, ByVal e As EventArgs)
        LimparSessaoPeriodo()
    ...
    Protected Sub DgAgendamentos_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles DgAgendamentos.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            Dim ID = Me.DgAgendamentos.DataKeys(e.Row.RowIndex).Value.ToString().ToInt()
        ...
        '    Dim Excluir As LinkButton = DirectCast(e.Row.FindControl("cmdExcluir"), LinkButton)
    ...
    'Private Sub ConsultarAgendamentos_PreRender(sender As Object, e As EventArgs) Handles Me.PreRender
    '    MakeGridViewPrinterFriendly(DgAgendamentos)
    'End Sub
End Class