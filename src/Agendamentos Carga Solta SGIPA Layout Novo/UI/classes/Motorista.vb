...
Public Class Motorista
    ...
    Public Function Inserir(ByVal Motorista As Motorista) As Boolean
        ...
        If Banco.BancoEmUso = "ORACLE" Then
            SQL.Append(String.Format("INSERT INTO OPERADOR.TB_AG_MOTORISTAS (AUTONUM,ID_TRANSPORTADORA,NOME,CNH,VALIDADE_CNH,RG,CPF,CELULAR,NEXTEL,NUMERO_MOP) VALUES ({0},{1},'{2}','{3}',TO_DATE('{4}', 'DD/MM/YY'),'{5}','{6}','{7}','{8}','{9}')", "OPERADOR.SEQ_AG_MOTORISTAS.NEXTVAL", Motorista.Transportadora.ID, Motorista.Nome, Motorista.CNH, Motorista.Validade, Motorista.RG, Motorista.CPF, Motorista.Celular, Motorista.Nextel, Motorista.NumeroMOP))
        Else
            SQL.Append(String.Format("INSERT INTO OPERADOR.TB_AG_MOTORISTAS (AUTONUM,ID_TRANSPORTADORA,NOME,CNH,VALIDADE_CNH,RG,CPF,CELULAR,NEXTEL,NUMERO_MOP) VALUES ({0},'{1}','{2}','{3}',TO_DATE('{4}', 'DD/MM/YY'),'{5}','{6}','{7}','{8}','{9}')", Motorista.Transportadora.ID, Motorista.Nome, Motorista.CNH, Motorista.Validade, Motorista.RG, Motorista.CPF, Motorista.Celular, Motorista.Nextel, Motorista.NumeroMOP))
        End If
    ...
    Public Function Alterar(ByVal Motorista As Motorista) As Boolean
        ...
        If Banco.BancoEmUso = "ORACLE" Then
            SQL.Append(String.Format("UPDATE OPERADOR.TB_AG_MOTORISTAS SET NOME='{0}',CNH='{1}',VALIDADE_CNH=TO_DATE('{2}', 'DD/MM/YY'),RG='{3}',CPF='{4}',CELULAR='{5}',NEXTEL='{6}',NUMERO_MOP={7} WHERE AUTONUM={8}", Motorista.Nome, Motorista.CNH, Motorista.Validade, Motorista.RG, Motorista.CPF, Motorista.Celular, Motorista.Nextel, Motorista.NumeroMOP, Motorista.ID))
        Else
            SQL.Append(String.Format("UPDATE OPERADOR.DBO.TB_AG_MOTORISTAS SET NOME='{0}',CNH='{1}',VALIDADE_CNH=TO_DATE('{2}', 'DD/MM/YY'),RG='{3}',CPF='{4}',CELULAR='{5}',NEXTEL='{6}',NUMERO_MOP={7} WHERE AUTONUM={8}", Motorista.Nome, Motorista.CNH, Motorista.Validade, Motorista.RG, Motorista.CPF, Motorista.Celular, Motorista.Nextel, Motorista.NumeroMOP, Motorista.ID))
        End If
    ...
    Public Function Excluir(ByVal Motorista As Motorista) As Boolean
        ...
        Else
            SQL.Append(String.Format("DELETE FROM OPERADOR.DBO.B_AG_MOTORISTAS WHERE AUTONUM={0}", Motorista.ID))
        End If
    ...
    Public Function Consultar(ByVal ID As Integer, Optional ByVal Filtro As String = "") As DataTable
        ...
        Rst.Open(String.Format(SQL.ToString(), ID, Filtro), Banco.Conexao, 3, 3)
    ...
    Public Function ObterValidadeCNH(ByVal CNH As String, ByVal Transportadora As String) As String
        ...
        Dim Rst As New ADODB.Recordset
        Rst.Open(String.Format("SELECT TO_CHAR(VALIDADE_CNH, 'DD/MM/YYYY') VALIDADE_CNH FROM OPERADOR.TB_AG_MOTORISTAS WHERE TRIM(CNH) = '{0}' AND ID_TRANSPORTADORA = {1}", CNH, Transportadora), Banco.Conexao, 3, 3)
    ...
    End Function
    Public Function ObterDadosCNHMotorista(ByVal CNH As String, ByVal Transportadora As String) As Motorista

        Dim Rst As New ADODB.Recordset

        Rst.Open(String.Format("SELECT AUTONUM, NOME, TO_CHAR(VALIDADE_CNH, 'DD/MM/YYYY') VALIDADE_CNH, CPF, CELULAR, NEXTEL, CNH FROM OPERADOR.TB_AG_MOTORISTAS WHERE TRIM(CNH) = '{0}' AND ID_TRANSPORTADORA = {1}", CNH, Transportadora), Banco.Conexao, 3, 3)
    ...
    Public Function ObterCPFMotorista(ByVal CNH As String, ByVal IdTransp As Integer) As String
        ...
        If Banco.BancoEmUso = "ORACLE" Then
            SQL = String.Format("SELECT CPF FROM OPERADOR.TB_AG_MOTORISTAS WHERE CNH = '{0}' AND ID_TRANSPORTADORA = {1}", CNH, IdTransp)
        Else
            SQL = String.Format("SELECT CPF FROM OPERADOR.DBO.TB_AG_MOTORISTAS WHERE CNH = '{0}' AND ID_TRANSPORTADORA = {1}", CNH, IdTransp)
        End If
