<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/master/Consultas.Master"
    CodeBehind="CadastrarMotoristas.aspx.vb" Inherits="AgendamentoCargaSoltaSGIPA.CadastrarMotoristas" %>
    ...
    <table id="tbcad" align="center" cellpadding="2" cellspacing="1" width="450px" bgcolor="#CCCCCC">
        <tr>
            <td align="center" class="CorPadrao" colspan="2" style="font-family: verdana; font-size: 11px;
                font-weight: bold; color: #FFFFFF" bgcolor="<%= Session("SIS_COR_PADRAO") %>">
        ...
        <tr>
            ...
            <td style="font-family: verdana; font-size: 11px" bgcolor="White">
                <asp:TextBox ID="txtCNH" runat="server" MaxLength="15" Width="120px" Font-Names="Verdana"
