<%@ Page Title="" Language="vb" EnableEventValidation="false" AutoEventWireup="false" MasterPageFile="~/master/Consultas.Master"
    CodeBehind="EtapasCargaSolta.aspx.vb" Inherits="AgendamentoCargaSoltaSGIPA.EtapasCargaSolta" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <form id="form1" runat="server" style="margin-top: 20px;">
        ...
        <div id="Grid-Scroll" style="overflow: auto; margin-left: 20px; margin-right: 20px;">
            ...
            <br />
            <asp:GridView ID="DgEtapasCs" runat="server" AutoGenerateColumns="False" CellPadding="1"
