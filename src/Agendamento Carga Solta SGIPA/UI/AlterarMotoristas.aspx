<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/master/Consultas.Master" CodeBehind="AlterarMotoristas.aspx.vb" Inherits="AgendamentoCargaSoltaSGIPA.AlterarMotoristas" %>
        ...
        <table id="tbcad" align="center" cellpadding="2" cellspacing="1" width="450px"
            ...
            <tr>
                <td align="center" class="CorPadrao" colspan="2"
                    style="font-family: verdana; font-size: 11px; font-weight: bold; color: #FFFFFF" bgcolor="<%= Session("SIS_COR_PADRAO") %>">Alterar Motoristas</td>
            </tr>
            <tr>
                <td style="font-family: verdana; font-size: 11px" width="100px" bgcolor="White">Transportadora</td>
            ...
            <tr>
                <td style="font-family: verdana; font-size: 11px" width="100px" bgcolor="White">CNH</td>
                <td style="font-family: verdana; font-size: 11px" bgcolor="White">
                    <asp:TextBox ID="txtCNH" runat="server" MaxLength="15" Width="120px"
                        Font-Names="Verdana" Font-Size="11px" CssClass="Numeric" Enabled="True"></asp:TextBox>
            ...
            <tr>
                <td style="font-family: verdana; font-size: 11px" width="100px" bgcolor="White">Validade CNH</td>
                <td style="font-family: verdana; font-size: 11px" bgcolor="White">
            ...
            <tr>
                <td style="font-family: verdana; font-size: 11px" width="100px" bgcolor="White">Nome</td>
                <td style="font-family: verdana; font-size: 11px" bgcolor="White">
                    <asp:TextBox ID="txtNome" runat="server" MaxLength="50" Width="200px"
                        Font-Names="Verdana" Font-Size="11px" Enabled="True"></asp:TextBox>
            ...
            <tr>
                <td style="font-family: verdana; font-size: 11px" width="100px" bgcolor="White">RG</td>
                <td style="font-family: verdana; font-size: 11px" bgcolor="White">
            ...
            <tr>
                <td style="font-family: verdana; font-size: 11px" width="100px" bgcolor="White">CPF</td>
                <td style="font-family: verdana; font-size: 11px" bgcolor="White">
            ...
            <tr>
                <td style="font-family: verdana; font-size: 11px" width="100px" bgcolor="White">Celular</td>
                <td style="font-family: verdana; font-size: 11px" bgcolor="White">
                    <asp:TextBox ID="txtCelular" runat="server" MaxLength="15" Width="120px" CssClass="telefone"
            ...
            <tr>
                <td style="font-family: verdana; font-size: 11px" width="100px" bgcolor="White">Nextel ID</td>
                <td style="font-family: verdana; font-size: 11px" bgcolor="White">
                    <asp:TextBox ID="txtNextel" runat="server" MaxLength="20" Width="120px"
                        Font-Names="Verdana" Font-Size="11px"></asp:TextBox>
