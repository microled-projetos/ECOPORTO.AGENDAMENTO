<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/master/Consultas.Master"
    CodeBehind="ConsultarAgendamentos.aspx.vb" Inherits="AgendamentoCargaSoltaSGIPA.ConsultarAgendamentos" %>
    ...
    <form id="form1" runat="server">
        <div id="ConteudoGeral" style="margin-left: 20px; margin-right: 20px;">
            ...
            <asp:GridView ID="DgAgendamentos" runat="server" AutoGenerateColumns="False" CellPadding="1"
                ...
                DataKeyNames="AUTONUM_AG_CS,DT_CHEGADA" AllowPaging="true" PageSize="20">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="PLACA CAVALO PLACA CARRETA">
                        <ItemTemplate>
                    ...
                    <asp:BoundField HeaderText="NÚMERO DOC SAÍDA" DataField="NUM_DOC_SAIDA" SortExpression="NUM_DOC_SAIDA">
                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                    </asp:BoundField>
