                    ...
                    FROM
                        (
                            ...
                            FROM
                                OPERADOR.TB_AG_VEICULOS A
                            INNER JOIN
                                OPERADOR.TB_AGENDAMENTO_TRA B ON A.AUTONUM = B.AUTONUM_VEICULO AND A.ID_TRANSPORTADORA = B.AUTONUM_TRANSPORTADORA
                            WHERE
                            ...
                            FROM
                                OPERADOR.TB_AG_VEICULOS A
                            INNER JOIN
                                OPERADOR.TB_AGENDAMENTO_DEPOT B ON A.AUTONUM = B.AUTONUM_VEICULO AND A.ID_TRANSPORTADORA = B.AUTONUM_TRANSPORTADORA
                            WHERE
                                A.ID_TRANSPORTADORA = :TransportadoraId
                            AND
                                ROWNUM <= 5                           
