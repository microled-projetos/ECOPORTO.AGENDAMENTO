<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/master/Site.Master"
    CodeBehind="AgendamentoRecusado.aspx.vb" Inherits="GPD.AgendamentoRecusado" %>
        ...
        <table id="tbcad" align="center" cellpadding="2" cellspacing="1" width="500px" bgcolor="#CCCCCC">
            ...
            <tr>
                <td style="font-family: verdana; font-size: 11px" bgcolor="White">
                    ...
                    <br />
                    <center>
                        <asp:LinkButton ID="lnkVoltar" runat="server" PostBackUrl="ConsultarAgendamentosImportacao.aspx">Voltar</asp:LinkButton>
                    </center>
                    <br />
                    <br />
                </td>
