<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/master/Site.Master" CodeBehind="AlterarVincTransp.aspx.vb" Inherits="GPD.AlterarVincTransp" %>
        ...
        <table id="tbcad" align="center" cellpadding="2" cellspacing="1" width="660px" bgcolor="#CCCCCC">
            <tr>
                <td align="center" class="CorPadrao" colspan="2" bgcolor="<%= Session("SIS_COR_PADRAO") %>"
                    ...
                    Editar Vinculação de Transportadora com Recinto</td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="center" colspan="2" style="font-family: verdana; font-size: 11px" 
                    ...
                    <asp:Button ID="btEditar" runat="server" BorderColor="#999999"
