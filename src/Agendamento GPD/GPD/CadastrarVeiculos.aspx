<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/master/Site.Master" CodeBehind="CadastrarVeiculos.aspx.vb" Inherits="GPD.CadastrarVeiculos" %>
        ...
        <table id="tbcad" align="center" cellpadding="2" cellspacing="1" width="450px"
            ...
            <tr>
                <td align="center" class="CorPadrao" colspan="2"
                    style="font-family: verdana; font-size: 11px; font-weight: bold; color: #FFFFFF" bgcolor="<%= Session("SIS_COR_PADRAO") %>">Cadastrar Veículos</td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="font-family: verdana; font-size: 11px" width="100px" bgcolor="White">Placa-Cavalo</td>
                <td style="font-family: verdana; font-size: 11px" bgcolor="White">
            ...
            <tr>
                <td style="font-family: verdana; font-size: 11px" width="100px" bgcolor="White">Placa-Carreta</td>
                <td style="font-family: verdana; font-size: 11px" bgcolor="White">
            ...
            <tr>
                <td style="font-family: verdana; font-size: 11px" width="100px" bgcolor="White">Tara Veículo</td>
                <td style="font-family: verdana; font-size: 11px" bgcolor="White">
            ...
            <tr>
                <td style="font-family: verdana; font-size: 11px" width="100px" bgcolor="White">Modelo</td>
                <td style="font-family: verdana; font-size: 11px" bgcolor="White">
            ...
            <tr>
                <td style="font-family: verdana; font-size: 11px" width="100px" bgcolor="White">Cor</td>
                <td style="font-family: verdana; font-size: 11px" bgcolor="White">
            ...
            <tr>
                <td style="font-family: verdana; font-size: 11px" width="100px" bgcolor="White">Chassi</td>
                <td style="font-family: verdana; font-size: 11px" bgcolor="White">
            ...
            <tr>
                <td style="font-family: verdana; font-size: 11px" width="100px" bgcolor="White">Renavam</td>
                <td style="font-family: verdana; font-size: 11px" bgcolor="White">
            ...
            <tr>
                <td style="font-family: verdana; font-size: 11px" width="100px" bgcolor="White">Tipo de Carreta</td>
                <td style="font-family: verdana; font-size: 11px" bgcolor="White">
