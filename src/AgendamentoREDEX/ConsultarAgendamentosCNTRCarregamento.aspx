<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master"
    CodeBehind="ConsultarAgendamentosCNTRCarregamento.aspx.vb" Inherits="AgendamentoREDEX.ConsultarAgendamentosCNTRCarregamento" %>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <center>
        <asp:Panel ID="pnFiltro" runat="server" Visible="false" Font-Size="12">
            <table id="tbpes" align="center" width="1000px" bgcolor="#999999" border="0" cellpadding="1"
                ...
                <tr>
                    ...
                    <td align="left" bgcolor="White" colspan="2" style="border-bottom-style: dotted;
                        ...
                        <asp:TextBox ID="txtConteiner" runat="server" Font-Names="Verdana" Font-Size="14px"
                            MaxLength="12" Width="500px"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td width="100px" align="left" bgcolor="White" colspan="2" style="border-bottom-style: dotted;
                        border-bottom-width: 1px; border-bottom-color: #999999; border-right-style: dotted;
                        border-right-width: 1px; border-right-color: #999999">
                        <asp:DropDownList ID="cbTipo" runat="server"  Width="505px"  DataTextField="TIPOBASICO"
                            DataValueField="TIPOBASICO" Font-Names="Verdana" Font-Size="14px">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="100px" align="left" bgcolor="White" colspan="2" style="border-bottom-style: dotted;
                        border-bottom-width: 1px; border-bottom-color: #999999; border-right-style: dotted;
                        border-right-width: 1px; border-right-color: #999999">
                        <asp:DropDownList ID="cbTamanho" runat="server"  Width="505px" Font-Names="Verdana"
                            Font-Size="14px">
                ...
                <tr>
                    ...
                    <td width="100px" align="left" bgcolor="White" colspan="2" style="border-bottom-style: dotted;
                        border-bottom-width: 1px; border-bottom-color: #999999; border-right-style: dotted;
                        border-right-width: 1px; border-right-color: #999999">
                        <asp:TextBox ID="txtPlacaCV" runat="server"  Width="500px" Font-Names="Verdana" Font-Size="14px"
                ...
                <tr>
                    ...
                    <td width="150px" align="left" bgcolor="White" colspan="2" style="border-bottom-style: dotted;
                        border-bottom-width: 1px; border-bottom-color: #999999; border-right-style: dotted;
                        border-right-width: 1px; border-right-color: #999999">
                        <asp:TextBox ID="txtPlacaCR" runat="server"  Width="500px" Font-Names="Verdana" Font-Size="14px"
                            MaxLength="8"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td width="240px" align="left" bgcolor="White" style="border-bottom-style: dotted;
                        border-bottom-width: 1px; border-bottom-color: #999999; border-right-style: dotted;
                        border-right-width: 1px; border-right-color: #999999">
                        <asp:TextBox ID="txtNavio" runat="server" Style="margin-left: 0px" Width="500px"
                            Font-Names="Verdana" Font-Size="14px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="100px" align="left" bgcolor="White" style="border-bottom-style: dotted;
                        border-bottom-width: 1px; border-bottom-color: #999999; border-right-style: dotted;
                        border-right-width: 1px; border-right-color: #999999">
                        <asp:DropDownList ID="cbFiltro2" runat="server"  Width="505px" Font-Names="Verdana"
                            Font-Size="14px">
                            <asp:ListItem Value="0">Exatamente Igual</asp:ListItem>
                            <asp:ListItem Value="1">Contém</asp:ListItem>
                        </asp:DropDownList>
                    ...
                    <td width="240px" align="left" bgcolor="White" style="border-right: 1px dotted #999999;
                        ...
                        <asp:TextBox ID="txtMotorista" runat="server" Style="margin-left: 0px"  Width="500px"
                            Font-Names="Verdana" Font-Size="14px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
        ...
        <asp:GridView ID="dgConsulta" runat="server" AutoGenerateColumns="False" CellPadding="4"
            ...
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="AUTONUM" DataNavigateUrlFormatString="ProtocoloCNTRCarregamento.aspx?protocolo={0}"
