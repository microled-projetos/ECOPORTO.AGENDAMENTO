...
Public Class ConsultarVeiculos
    ...
    Private Sub Consultar()
        ...
        If Session("FILTRO_CONSULTA_VEICULOS") IsNot Nothing Then
            DgVeiculos.DataSource = Banco.List(VeiculoBLL.Consultar(Session("SIS_AUTONUM_TRANSPORTADORA").ToString(), Session("FILTRO_CONSULTA_VEICULOS").ToString()))
        Else
            DgVeiculos.DataSource = Banco.List(VeiculoBLL.Consultar(Session("SIS_AUTONUM_TRANSPORTADORA").ToString(), ""))
        End If
